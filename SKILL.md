...
description: 将 OpenClaw 内置命令描述从英文翻译为中文。当用户想要汉化 OpenClaw 命令、修改命令描述为中文、或提到"命令中文化"/"指令注释中文"时使用。
version: 1.0.0
license: MIT
tags: openclaw, i18n, chinese, localization
---
...
- `scripts/translate-commands.py` - 主脚本
